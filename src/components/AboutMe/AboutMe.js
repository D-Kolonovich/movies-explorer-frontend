      ...
      <div className="about-me__wrapper">
        ...
        <div className="about-me__info">
          ...
          <p className="about-me__about">
            Я родился и живу в Гродно, закончил факультет экономики и управления
            ГрГУ. Я люблю слушать музыку, а ещё увлекаюсь ноутбуками. Недавно
            начал кодить. С 2015 года работал в «Приорбанк». После того, как
          ...
          <ul className="about-me__links">
            ...
            <li>
              <a href="https://github.com/D-Kolonovich" target="blank">
                Github
              </a>
            </li>
          </ul>
